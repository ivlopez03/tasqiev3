    ...
    return (
        <div className="w-full h-screen flex self-center place-content-center place-items-center ">
            ...
            <div className="w-96 text-gray-600 space-y-2  p-9 shadow-xl border rounded-xl top-[-40px] relative">
                <div className="chat chat-start absolute right-[-300px]">
                    <div className="chat-bubble chat-bubble-secondary text-sm"> Do not have an account?<span className="m-1 text-yellow-100 underline">Sign up</span>for an account now.</div>
                </div>
                <div className="flex place-content-center  pb-5">
                    <img src="/icon.png" className="w-24  "></img>
                </div>
                <div className="">
                    <button className="btn w-full relative m-2">
                    ...
                    <button className="btn btn-neutral  w-full relative m-2">
                        <div className="absolute left-4">
