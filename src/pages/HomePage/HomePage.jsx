    ...
    return (
        <div className="bg-[#fafafa] h-screen" >
            <div className="relative">
                <div className="border-b p-4 flex items-center relative justify-between bg-white">
                ...
                <div className="p-5"> 
                    <div className="pb-5">
                        ...
                        <div>
                            <span className="text-[#909090] font-light">{formatTodayDate()}</span>
                        </div>
                    </div>                   
                    <div>
                        <div className="p-2 w-[600px] max-h-[370px] border rounded-md shadow-sm  bg-white">
                            <div className="flex items-centertext-md px-3 relative">
                                <div className="flex items-center gap-1">Workspaces <span className="text-white bg-black text-[9px] px-2 py-1 rounded-xl">{workspaces.length}</span></div>
